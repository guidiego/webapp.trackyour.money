...
export const TestComponent: React.FC = () => (
  <div className="flex">
    <div className="flex-none w-48 relative">
      <img
        src="https://www.engelhorn.de/dw/image/v2/AALR_PRD/on/demandware.static/-/Sites-engelhorn-master-plattform/default/dw74785eac/images/P10/05/26/2B/V1068976L/engelhorn-Wellensteyn-Herren-Jacke-Marvellous-Vorderansicht-V1068976L-v1.jpg?sw=680"
        alt=""
